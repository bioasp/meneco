...
def test_meneco() : 
    unproducible_targets_result, reconstructable_result, essential_reactions_target_result, one_min_sol_result, intersection_sol_result, union_sol_result, enumeration_sol_result = meneco.run_meneco('../toy/draft.sbml', '../toy/seeds.sbml', '../toy/targets.sbml', '../toy/repair.sbml', True)
    ...
    assert essential_reactions_target_sol == essential_reactions_target_result
    assert one_min_sol == one_min_sol_result
    assert union_sol == union_sol_result
    assert intersection_sol == intersection_sol_result
